# A Comparative Study of Text-to-Image Generation Models, KIISE conf. 2023 (code not publicly available)
...
* `inference_for_demo.py` contains the refactored inference code of 5 models (Source code optimization, not Hugging Face.)
