...
class minDALLE(object):
    ...
    def txt2img(self, prompt):
        ...
        images = images[rank]
        images = images[:3,:,:,:] #3장일때 1->3
        print(images.shape)

        images = self.refactor1(images) #3장일때 refactor1

        # to image
        outpath = 'outputs_demo/minDALLE/' 
...
class Karlo(BaseSampler):
    def __init__(
        ...
        config = OmegaConf.load("../flask/karlo/configs/decoder_900M_vit_l.yaml")
